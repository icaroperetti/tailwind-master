...
export function Trigger() {
  ...
  return (
    <label
      htmlFor={id}
      className="flex flex-1 cursor-pointer flex-col items-center gap-3 rounded-lg border border-zinc-300 px-3 py-4 text-center text-zinc-500 shadow-sm hover:border-violet-200 hover:bg-violet-25 hover:text-violet-500 dark:border-zinc-800 dark:hover:border-zinc-700 dark:hover:bg-zinc-800 dark:hover:text-violet-300"
    >
      Selecionar Arquivo
      ...
      <div className="flex flex-col items-center gap-1">
        ...
        <span className="text-xs">PNG, JPG or GIF (max. 800x400px)</span>
      </div>
    </label>
  )
}
