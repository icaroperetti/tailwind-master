      ...
      <div className="mt-6 flex flex-col">
        ...
        >
          <div className="flex flex-col gap-3 lg:grid lg:grid-cols-form">
            <label
              htmlFor="firstName"
              className="text-zinc-700d text-sm font-medium dark:text-zinc-300"
            >
              Name
            </label>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            <label
              htmlFor="email"
              className="text-zinc-700d text-sm font-medium dark:text-zinc-100"
            >
              Email address
            </label>
          ...
          <div className="flex flex-col gap-3 pt-5 lg:grid lg:grid-cols-form">
            ...
            <Select placeholder="Select a timezone">
              ...
              />
              <SelectItem value="utc3" text="America/Sao_Paulo" />
            </Select>
          </div>
          ...
          <div className="flex items-center justify-end gap-2 pb-5 pt-5 lg:pb-0">
            <Button type="button" variant="outline">
              Cancel
            </Button>
            <Button type="submit" form="settings" variant="primary">
